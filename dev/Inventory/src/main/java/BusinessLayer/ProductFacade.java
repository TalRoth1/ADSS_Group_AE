        ...
        for (Integer branchID : branchIDs)
        {
            ...
            for (ProductBL product : products.values())
            {
                ...
                if (currentQuantity <= minimalQuantity)
                {
                    ...
                    body.append("  Product: ").append(product.getName()).append(" (Product ID: ").append(product.getProductID()).append(") ").append("Current Quantity: ").append(currentQuantity).append(", Minimal Required: ").append(minimalQuantity).append("\n");
                }
            }
            if (!hasDeficiency)
            {
                body.append("Branch: ").append(branchName).append(" (ID: ").append(branchID).append(") - No deficiencies.\n");
            }
        }
        ...
        else
        {
            for (Integer branchID : branchIDs)
            {
                ...
                for (ItemBL item : branchToExpiredItems.get(branchID))
                {
                    ...
                    body.append("  Item ID: ").append(item.getItemID()).append(", Product: ").append(productName).append(", Expiration Date: ").append(item.getExpirationDate()).append(", Location: ").append(item.getLocation()).append("\n");
                }
            }
        }
        ...
        else
        {
            for (Integer branchID : branchIDs)
            {
                ...
                for (ItemBL item : branchToDefectedItems.get(branchID)) {
                    String productName = products.get(item.getProductID()).getName();
                    body.append("  Item ID: ").append(item.getItemID()).append(", Product: ").append(productName).append(", Location: ").append(item.getLocation()).append("\n");
                }
            }
        }
