...
public class LocationController {
    ...
    public void addLocation(LocationDTO location) throws SQLException {
        locationCheck(location.getStreet(), location.getStreetNumber(), location.getCity(), location.getContactNumber(),
                location.getContactName(), location.getZone());
        locationDAO.addLocation(generateId(), location.getStreet(), location.getStreetNumber(), location.getCity(),
     ...
     * String contactNumber, String contactName, String zone) {
     * return (street == null || streetNumber <= 0 || city == null || contactNumber
     * == null || contactName == null || zone == null);
     * }
     */

    private void locationCheck(String street, int streetNumber, String city, String contactNumber, String contactName,
            String zone) {
        if (street == null || streetNumber <= 0 || city == null || contactNumber == null || contactName == null
                || zone == null) {
