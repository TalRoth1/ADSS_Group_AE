...
//        facade.CreateShipment(truck, origin, List.of(destination), items);
...
//        TruckDL truck = facade.AddTruck(1, "TeslaX", "TypeA", 1000);
//        TruckDL foundTruck = facade.truckController.getTruck(truck.getId());
...
//        float weight = 1.0f;
//        facade.AddItem(itemName, weight);
//        ItemDTO foundItem = facade.itemController.getItem(itemName);
...
//        facade.CreateShipment(truck, driver, origin, List.of(destination), items);
//        ShipmentDL shipment = facade.shipments.getFirst();
//        ShipmentDL foundShipment = facade.shipmentController.getShipment(shipment.getId());
...
//        Map<LocationDL, Map<String, Integer>> items = Map.of(destination, Map.of("egg carton", 1, "milk", 2));
//        facade.CreateShipment(truck, driver, origin, List.of(destination), items);
//        DriverDL foundDriver = facade.shipments.getFirst().getDriverName();
