...
public class OrderSL
{
    ...
    OrderSL(int orderID, int supplierID, String destination, List<OrderItemSL> orderItems){
    ...
    OrderSL(int orderID, int supplierID, Date orderDate, String destination, List<OrderItemSL> orderItems, OrderStatus orderStatus){
        this.orderID = orderID;
        this.supplierID = supplierID;
