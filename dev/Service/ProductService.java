...
public class ProductService {
    ...
    public Response AddProduct(String name, double sellingPrice, int discount,
            int producerID, String[] categories) {
        try {
            int productID = pf.addProduct(name, sellingPrice, discount, producerID, categories);
